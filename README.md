...
Современный Telegram бот для покупки и управления VPN ключами через Outline Server с оплатой через Telegram Stars.

## 🚀 Возможности

### 💎 Система покупки ключей
...
3. **Управление**: "📋 Мои ключи" → просмотр статистики и VPN ключей
