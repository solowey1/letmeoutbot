...
class TelegramBot {
	constructor() {
		...
		this.xrayService = new XRayService(config.xray.panelUrl, config.xray.apiKey, config.xray.publicKey, config.xray.subBaseUrl, config.xray.hysteria2InboundId, config.xray.hysteria2Port, config.xray.hysteria2Sni);
